      ...
      <div className="container flex flex-col gap-12 py-16 md:py-24 px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2 space-y-6">
            ...
            <p className="text-white/40 text-lg font-medium max-w-sm leading-relaxed">
              The ultimate AI-powered note-taking experience for professionals and students. Elevate your productivity today.
            </p>
          </div>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6">
          <p className="text-white/20 text-sm font-medium">
            © {new Date().getFullYear()} Notemind.ai. All rights reserved. Built with passion for the intelligent era.
          </p>
